...
A/B Testing dilakukan untuk membandingkan dashboard Versi A dan Versi B berdasarkan kriteria penilaian dari kebutuhan project.

Kriteria penilaian meliputi struktur tampilan, interaktivitas grafik, kebutuhan scroll, kelengkapan filter, ringkasan KPI, insight otomatis, fitur download data, dan kesesuaian sebagai dashboard interaktif.

Evaluasi ini bersifat berbasis fitur, bukan uji statistik pengguna, karena belum menggunakan data responden.

Hasil evaluasi menunjukkan bahwa dashboard Versi B lebih sesuai digunakan sebagai dashboard final karena memiliki tampilan yang lebih rapi, grafik interaktif, filter yang relevan, KPI, insight otomatis, dan fitur download data.
